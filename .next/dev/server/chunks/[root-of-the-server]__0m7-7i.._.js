...
"[project]/app/api/health/supabase/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { count, error } = await supabase.from("species").select("id", {
            count: "exact",
            head: true
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0m7-7i.._.js.map