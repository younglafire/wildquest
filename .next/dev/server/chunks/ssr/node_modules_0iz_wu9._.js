...
"[project]/node_modules/@solana/kit-plugin-instruction-plan/dist/index.node.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function transactionPlanner(transactionPlanner2) {
    return (client)=>({
            ...client,
            transactionPlanner: transactionPlanner2
        });
}
function transactionPlanExecutor(transactionPlanExecutor2) {
    return (client)=>({
            ...client,
            transactionPlanExecutor: transactionPlanExecutor2
        });
}
...
function getTransactionPlanningAndSendingFunctions(client) {
    const planTransactions = async (input, config = {})=>{
        const instructionPlan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseInstructionPlanInput"])(input);
    ...
    const planTransaction = async (input, config = {})=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertIsSingleTransactionPlan"])(transactionPlan);
        return transactionPlan.message;
    };
    const sendTransactions = async (input, config = {})=>{
        const plan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseInstructionOrTransactionPlanInput"])(input);
        config?.abortSignal?.throwIfAborted();
        const transactionPlan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTransactionPlan"])(plan) ? plan : await planTransactions(plan, config);
        config?.abortSignal?.throwIfAborted();
        try {
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createFailedToSendTransactionsError"])(error.context.transactionPlanResult, error.context.abortReason);
        }
    };
    const sendTransaction = async (input, config = {})=>{
        const plan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseInstructionOrTransactionPlanInput"])(input);
        config?.abortSignal?.throwIfAborted();
        const transactionPlan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTransactionPlan"])(plan) ? plan : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["singleTransactionPlan"])(await planTransaction(plan, config));
        config?.abortSignal?.throwIfAborted();
        try {
            const result = await client.transactionPlanExecutor(transactionPlan, config);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertIsSuccessfulSingleTransactionPlanResult"])(result);
            return result;
        } catch (error) {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2f$node_modules$2f40$solana$2f$errors$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSolanaError"])(error, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2f$node_modules$2f40$solana$2f$errors$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SOLANA_ERROR__INSTRUCTION_PLANS__FAILED_TO_EXECUTE_TRANSACTION_PLAN"])) {
                throw error;
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertIsSingleTransactionPlanResult"])(error.context.transactionPlanResult);
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instruction$2d$plans$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createFailedToSendTransactionError"])(error.context.transactionPlanResult, error.context.abortReason);
        }
    };
    return {
        planTransaction,
...
"[project]/node_modules/@solana/kit-plugin-payer/dist/index.node.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generatedPayer() {
    return async (client)=>({
            ...client,
            payer: await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateKeyPairSigner"])()
        });
}
function generatedPayerWithSol(amount) {
    const generatedPayerPlugin = generatedPayer();
    return async (client)=>{
        const clientWithPayer = await generatedPayerPlugin(client);
...
function payerFromFile(path) {
    return async (client)=>{
        const bytes = JSON.parse((0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readFileSync"])(path, "utf-8"));
        const payer2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createKeyPairSignerFromBytes"])(new Uint8Array(bytes));
        return {
            ...client,
            payer: payer2
        };
...
function payerOrGeneratedPayer(explicitPayer) {
    return (client)=>{
        ...
        return generatedPayerWithSol((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$rpc$2d$types$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lamports"])(100000000000n))(client);
    };
}
;
}),
"[project]/node_modules/@solana/kit-client-rpc/dist/index.node.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$instruction$2d$plan$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/kit-plugin-instruction-plan/dist/index.node.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$payer$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/kit-plugin-payer/dist/index.node.mjs [app-ssr] (ecmascript)");
...
function createClient(config) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$plugin$2d$core$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyClient"])().use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rpc"])(config.url, config.rpcSubscriptionsConfig)).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$payer$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["payer"])(config.payer)).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rpcTransactionPlanner"])({
        priorityFees: config.priorityFees
    })).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rpcTransactionPlanExecutor"])({
        maxConcurrency: config.maxConcurrency,
        skipPreflight: config.skipPreflight
    })).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$instruction$2d$plan$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["planAndSendTransactions"])());
}
function createLocalClient(config = {}) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$plugin$2d$core$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyClient"])().use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["localhostRpc"])(config.url, config.rpcSubscriptionsConfig)).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rpcAirdrop"])()).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$payer$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["payerOrGeneratedPayer"])(config.payer)).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rpcTransactionPlanner"])({
        priorityFees: config.priorityFees
    })).use((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$kit$2d$plugin$2d$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rpcTransactionPlanExecutor"])({
        maxConcurrency: config.maxConcurrency,
        skipPreflight: config.skipPreflight
...
"[project]/node_modules/@solana/programs/node_modules/@solana/errors/dist/index.node.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$programs$2f$node_modules$2f40$solana$2f$errors$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/programs/node_modules/@solana/errors/dist/index.node.mjs [app-ssr] (ecmascript)");
;
...
//# sourceMappingURL=node_modules_0iz_wu9._.js.map